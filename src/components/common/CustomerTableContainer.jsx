  ...
  return (
    <div className="flex-1 min-w-0">
      ...
      <NoteModal
        ...
        maxLength={350}
      />
      {/* Viewer modal: read-only display of a selected note */}
      <NoteModal
        ...
        viewMeta={
          noteManager.viewingNote
            ? { createdAt: noteManager.viewingNote.createdAt, sales: noteManager.viewingNote.sales, index: (noteManager.viewingNoteIndex != null ? noteManager.viewingNoteIndex + 1 : null) }
            : null
        }
      />
    </div>
